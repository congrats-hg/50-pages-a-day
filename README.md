...
|:---:|---:|:---:|:---|
|  |  |  |  |
| 251123 | [OpenAI Cookbook / GPT-5 New Params and Tools](https://cookbook.openai.com/examples/gpt-5/gpt-5_new_params_and_tools) | 10 | - Recommended: Responses API with GPT-5 series of model to get the most performance out of the models <br> - high verbosity → great for hand-offs <br> - Use `from IPython.display import display` for structured output on terminal <br> - |
